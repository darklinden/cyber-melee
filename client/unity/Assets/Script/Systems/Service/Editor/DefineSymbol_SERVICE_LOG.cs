...
public static class DefineSymbol_SERVICE_LOG
{
    public const string SYMBOL_NAME = "SERVICE_LOG";

    public const string MENU_TITLE = "Tools/Define Symbol/Service/" + SYMBOL_NAME;
