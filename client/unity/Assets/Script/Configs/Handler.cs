    ...
    public partial class Handler
    {
        ...
        public void Initialize()
        {
            ...
            for (int i = 0; i < typelist.Count; i++)
            {
                ...
                if (typeInstance is IConfigLoader)
                {
                    ...
                    {
                        // Log.D($"Initialize add {loader.GetType().Name} to start load");
                    ...
                    {
                        // Log.D($"Initialize add {loader.GetType().Name} to demand load");
        ...
        public async UniTask AsyncLoadStart()
        {
            ...
            for (int i = 0; i < m_StartLoadSortList.Count; i++)
            {
                ...
                {
                    // Log.D($"AsyncLoadStart {loaders[j].GetType().Name}");
