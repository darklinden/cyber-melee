...
namespace Wtf.Editor
{
    ...
    {
        private const string EditorPrefsKey = "Tools.FontReplacerTMP";
        private const string MenuItemName = "Tools/Fonts/Replace TMProFonts...";
        ...
        {
            var window = GetWindow<FontReplacerTMP>(true, "Replace TMProFonts");
